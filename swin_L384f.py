...
data = dict(
    ...
    train=dict(
        ...
        ann_file=
        '/opt/ml/segmentation/input/stratified_train/labeling_data.json',
        img_prefix='/opt/ml/segmentation/input/stratified_train/',
        ...
        dataset=dict(
            ...
            classes=('General trash', 'Paper', 'Paper pack', 'Metal', 'Glass',
                     ...
                     'Clothing'),
            seg_prefix='/opt/ml/segmentation/input/stratified_train/mask',
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(
                    type='InstaBoost',
