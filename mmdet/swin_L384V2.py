...
data = dict(
    ...
    train=[
        dict(
            ...
            dataset=dict(
                type='CocoDataset',
                ann_file=
                '/opt/ml/segmentation/input/train_all/labeling_data.json',
                img_prefix='/opt/ml/segmentation/input/train_all/',
                classes=('General trash', 'Paper', 'Paper pack', 'Metal',
                         'Glass', 'Plastic', 'Styrofoam', 'Plastic bag',
                         'Battery', 'Clothing'),
                seg_prefix='/opt/ml/segmentation/input/train_all/mask',
                pipeline=[
                    dict(type='LoadImageFromFile'),
                    dict(
                        type='InstaBoost',
                        ...
                        transforms=[
                            ...
                            dict(
                                ...
                                transforms=[
                                    dict(type='Blur', blur_limit=3, p=1.0),
                                    dict(
                                        type='MedianBlur', blur_limit=3, p=1.0)
                                ],
                                p=0.5)
                        ],
                        bbox_params=dict(
        ...
        dict(
            type='CocoDataset',
            ann_file='/opt/ml/segmentation/merge_image/labeling_data.json',
            img_prefix='/opt/ml/segmentation/merge_image/',
            classes=('General trash', 'Paper', 'Paper pack', 'Metal', 'Glass',
                     'Plastic', 'Styrofoam', 'Plastic bag', 'Battery',
                     'Clothing'),
            seg_prefix='/opt/ml/segmentation/merge_image/mask',
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(
                    type='InstaBoost',
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/opt/ml/segmentation/input/stratified_val/labeling_data.json',
        img_prefix='/opt/ml/segmentation/input/stratified_val/',
        classes=('General trash', 'Paper', 'Paper pack', 'Metal', 'Glass',
        ...
        seg_prefix='/opt/ml/segmentation/input/stratified_val/mask'),
    test=dict(
        type='CocoDataset',
        ann_file='/opt/ml/segmentation/input/data/test.json',
        img_prefix='/opt/ml/segmentation/input/data/',
        classes=('General trash', 'Paper', 'Paper pack', 'Metal', 'Glass',
                 'Plastic', 'Styrofoam', 'Plastic bag', 'Battery', 'Clothing'),
        pipeline=[
            dict(type='LoadImageFromFile'),
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='mmdetection_segmentation', name='swin-L htc'))
    ])
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=100,
            mask_thr_binary=0.5)))
albu_mask_transforms = [dict(type='GridDropout', always_apply=False, p=0.5)]
...
ClassBaldataset = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        ann_file='/opt/ml/segmentation/input/train_all/labeling_data.json',
        img_prefix='/opt/ml/segmentation/input/train_all/',
        classes=('General trash', 'Paper', 'Paper pack', 'Metal', 'Glass',
                 'Plastic', 'Styrofoam', 'Plastic bag', 'Battery', 'Clothing'),
        seg_prefix='/opt/ml/segmentation/input/train_all/mask',
...
seed = 2021
work_dir = './work_dirs/swin_L384htc'
gpu_ids = range(0, 1)
